...
const INPUT_BINDING_ROWS: Array[Dictionary] = [
	...
	{
		"key": SETTINGS_KEYS.INPUT_INTERACT,
		"label_key": "ui_settings_input_interact",
		"label_path": "Root/Center/Panel/Margin/Layout/InputBindingsGrid/InteractBindingBox/InteractBindingLabel",
		"option_path": "Root/Center/Panel/Margin/Layout/InputBindingsGrid/InteractBindingBox/InteractBindingOption",
	},
	{
