...
func navigate_on_tree(event: InputEvent) -> void:
...
func focus_tree_item(item: TreeItem) -> void:
...
func update_tree_filter() -> void:
	update_tree()

func save_selection(selected: bool, item: TreeItem) -> void:
	if (selected):
