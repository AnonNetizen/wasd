...
const _SEED_SOURCE = preload("res://addons/phantom_camera/scripts/phantom_camera_seed_source.gd")
...
func _init() -> void:
	...
	if randomize_noise_seed: _noise_algorithm.seed = _SEED_SOURCE.next_seed()
...
func set_randomize_noise_seed(value: bool) -> void:
	...
	if value: _noise_algorithm.seed = _SEED_SOURCE.next_seed()
