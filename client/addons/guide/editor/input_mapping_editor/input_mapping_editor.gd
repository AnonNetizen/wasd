...
func _update() -> void:
	...
	for i in _mapping.modifiers.size():
		var modifier_slot:Variant = modifier_slot_scene.instantiate()
	...
	for i in _mapping.triggers.size():
		var trigger_slot:Variant = trigger_slot_scene.instantiate()
...
func _on_modifiers_add_requested() -> void:
...
func _on_triggers_add_requested() -> void:
...
func _fill_popup(popup:PopupMenu, base_clazz:StringName) -> void:
	popup.clear(true)
...
func _on_input_display_clicked() -> void:
	if is_instance_valid(_mapping.input):
		EditorInterface.edit_resource(_mapping.input)


func _on_input_changed(input:GUIDEInput) -> void:
...
func _on_edit_input_button_pressed() -> void:
...
func _on_clear_input_button_pressed() -> void:
...
func _on_add_trigger_popup_index_pressed(index:int) -> void:
...
func _on_modifier_changed(index:int, slot:Variant) -> void:
...
func _on_trigger_changed(index:int, slot:Variant) -> void:
...
func _on_modifiers_collapse_state_changed(new_state:bool) -> void:
	_mapping.set_meta("_guide_modifiers_collapsed", new_state)

func _on_triggers_collapse_state_changed(new_state:bool) -> void:
	_mapping.set_meta("_guide_triggers_collapsed", new_state)


func _on_edit_input_mapping_button_pressed() -> void:
