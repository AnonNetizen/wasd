...
func _on_select_bool_button_pressed() -> void:
	_show_inputs_of_value_type(GUIDEAction.GUIDEActionValueType.BOOL)


func _on_select_1d_button_pressed() -> void:
	_show_inputs_of_value_type(GUIDEAction.GUIDEActionValueType.AXIS_1D)


func _on_select_2d_button_pressed() -> void:
	_show_inputs_of_value_type(GUIDEAction.GUIDEActionValueType.AXIS_2D)


func _on_select_3d_button_pressed() -> void:
	_show_inputs_of_value_type(GUIDEAction.GUIDEActionValueType.AXIS_3D)


func _on_input_detector_detection_started() -> void:
	_instructions_label.text = tr("Actuate the input now...")


func _on_input_detector_input_detected(input:GUIDEInput) -> void:
...
func _begin_detect_input(type:GUIDEAction.GUIDEActionValueType) -> void:
