...
func initialize(mapping_contexts:Array[GUIDEMappingContext], remapping_config:GUIDERemappingConfig) -> void:
...
class ConfigItem:
	...
	func _init(context:GUIDEMappingContext, action:GUIDEAction, index:int, input_mapping:GUIDEInputMapping) -> void:
	...
	func _item_changed(item:ConfigItem, input:GUIDEInput) -> void:
