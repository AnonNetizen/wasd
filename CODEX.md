...
> **AI 修改说明**：修改本文档前先读 `docs/AI协作/文档维护指南.md`。本文档是 Codex CLI 的轻量入口适配；改 Codex 平台入口、agent、command 或规则加载方式时，必须同步 `AGENTS.md`、`OPENCODE.md`、`.codex/`、`.opencode/`（如影响跨平台通用能力）、`docs/AI协作/工具适配指南.md`、`docs/AI导航.md`、`docs/AI记忆/项目记忆.md`。
