...
| 改局外成长 / 元进度 | `docs/游戏设计文档.md` §7.2、`docs/代码/meta_progression_system.md`、`client/data/README.md`、`docs/词表与契约.md` §13、`docs/测试策略.md` | `client/scripts/autoload/meta_progression_system.gd`、`client/data/meta_progression.json`、locale、GDD、词表、AI导航、SaveManager / F4 runtime 模块文档 | `python tools/sync_contracts.py --check` + `python tools/validate_data.py`；代码落地后跑 `python tools/godot_bridge.py --project client meta-smoke`，改 F4 死亡接入时追加 `f4-smoke` |
...
| 写/改 F6 局外成长闭环 | `docs/AI协作/工作包/F6-MetaProgression.md`、`docs/代码/meta_progression_system.md`、`docs/游戏设计文档.md` §7.2 / §9.16、`docs/代码/save_manager.md`、`client/data/README.md` 的 `meta_progression.json` 段 | `MetaProgressionSystem`、结算流程、`client/data/meta_progression.json`、locale、SaveManager / F4 runtime 模块文档、AI导航 | `python tools/sync_contracts.py --check`、`python tools/validate_data.py`、`python tools/godot_bridge.py --project client meta-smoke`；改 run / SaveManager envelope 时追加 `save-smoke`，改 F4 死亡接入时追加 `f4-smoke` |
