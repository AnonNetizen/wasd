...
| #98 | 类型定位改为刷宝动作生存；参考星际战甲 / 暗黑的装备、词条、长期养成与刷战利品循环（当前视角、机关和资产口径已由 #100~#104 更新为固定斜俯视 2.5D） | README、GDD、IP设定、术语表、AI导航、CICD规划、功能建议池、AI记忆、平台规则 / skills |
...
| #103 | 通用机关改为哈迪斯式菱形危险地块；`Hazard` 占位表现和触发判定都使用菱形范围，`hazards.csv.radius` 为菱形半对角线 | GDD、`client/data/README.md`、AI导航、Gameplay runtime 文档、HazardSystem 文档、`client/scripts/gameplay/hazard.gd`、AI记忆 |
