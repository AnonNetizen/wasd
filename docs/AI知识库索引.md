...
| #98 | 类型定位改为刷宝动作生存；参考星际战甲 / 暗黑的装备、词条、长期养成与刷战利品循环（当前视角口径已由 #100 更新为固定斜俯视 2.5D） | README、GDD、IP设定、术语表、AI导航、CICD规划、功能建议池、AI记忆、平台规则 / skills |
...
| #100 | 当前正式视角口径改为固定斜俯视 2.5D 刷宝动作生存；`CenteredCamera` 固定斜俯视投影，鼠标瞄准按投影反算世界方向，玩法仍是 2D 平面 | README、GDD、IP设定、术语表、AI导航、Gameplay runtime 文档、`client/scripts/gameplay/player.gd`、`client/tools/runtime_smoke.gd`、AI记忆、平台规则 |
