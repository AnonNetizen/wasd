...
| 改装备 Mod / 局外装配 | `docs/游戏设计文档.md` §7.2、`docs/AI协作/工作包/F11-GearModLoadout.md`、`docs/代码/gear_mod_system.md`、`client/data/README.md`、`docs/词表与契约.md`、`docs/测试策略.md` | `client/scripts/autoload/gear_mod_system.gd`、`client/scripts/ui/gear_mod_panel.gd`、`client/data/gear_mods.json`、`client/data/gear_mod_drop_tables.csv`、`client/data/gear_mod_fusion_costs.csv`、locale、GDD、词表、AI导航、SaveManager / gameplay runtime 模块文档 | `python tools/sync_contracts.py --check` + `python tools/validate_data.py`；代码落地后跑 Gear Mod 专用 smoke 或等价 `l1-smoke` / `runtime-smoke`；影响开局属性 snapshot 时评估 golden replay |
| 维护旧局外成长 / 元进度迁移 | `docs/代码/meta_progression_system.md`、`docs/AI协作/工作包/F6-MetaProgression.md`、`docs/代码/gear_mod_system.md`、GDD §7.2 / §9.16 | `MetaProgressionSystem`、`meta_progression.json`、旧 profile 迁移 / 补偿、SaveManager meta 兼容 | 旧系统只作 legacy 迁移；若改迁移逻辑跑 `meta-smoke` / `save-smoke` 和文档健康检查 |
...
| 写/改 F11 装备 Mod / 局外装配 | `docs/AI协作/工作包/F11-GearModLoadout.md`、`docs/代码/gear_mod_system.md`、GDD §7.2 / §9.16、`client/data/README.md`、`docs/测试策略.md` | `GearModSystem`、Gear Mod UI、`gear_mods.json`、`gear_mod_drop_tables.csv`、`gear_mod_fusion_costs.csv`、SaveManager meta payload、旧 MetaProgression 迁移、locale、词表、AI导航 | `python tools/sync_contracts.py --check`、`python tools/validate_data.py`、Gear Mod 专用 smoke 或等价 `l1-smoke` / `runtime-smoke`；改存档迁移追加 `save-smoke`，影响稳定行为时评估 golden |
