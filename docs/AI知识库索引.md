...
| 写/改 F6 局外成长闭环 | `docs/AI协作/工作包/F6-MetaProgression.md`、`docs/游戏设计文档.md` §7.2 / §9.16、`docs/代码/save_manager.md`、`client/data/README.md` 的 `meta_progression.json` 段 | `MetaProgressionSystem`、结算流程、`client/data/meta_progression.json`、locale、SaveManager / F4 runtime 模块文档、AI导航 | `python tools/sync_contracts.py --check`、`python tools/validate_data.py`、`python tools/godot_bridge.py --project client save-smoke`；代码落地后追加 F6 smoke / MetaProgressionSystem 测试 |
