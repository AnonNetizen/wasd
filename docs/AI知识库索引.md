...
| #146 | F14 活动目标流场从完整 99×99 Dijkstra 修正为最大视觉范围驱动的局部有界重建；当前半径 8、最多 289 格，只清理上次触达索引并使用并行数值堆；完整 mask、视线和守家 / 记忆 AStar 保持全图，run v4 与 profile schema v3 不变 | F14 工作包、GDD v1.23 §5.3、EnemyAI / ModuleWorldManager / Gameplay Runtime 文档、测试策略、AI导航、current_state、AI记忆 |
