...
4. **是不是正式项目阶段任务**？优先读 `工作包/`；当前 F10 战区导演用 `工作包/F10-WarzoneDirector.md`，F9 Demo 内容 / 表现打磨看 `工作包/F9-ContentDemoPolish.md`，F8 回放 / 测试 / 平衡维护看 `工作包/F8-ReplayTestingBalance.md`，F7 设置 / 本地化 / UI 栈维护看 `工作包/F7-SettingsLocalizationUI.md`，F6 局外成长闭环看 `工作包/F6-MetaProgression.md`，F4 最小可玩闭环看 `工作包/F4-MinPlayableLoop.md`，历史 F3 数据闭环看 `工作包/F3-DataLoader.md`。
