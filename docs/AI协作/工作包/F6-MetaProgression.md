...
>
> **历史状态**：本工作包记录 F6 旧局外成长首片的历史实现路线。ADR #117 已删除旧运行时 / UI，ADR #118 后项目未上线、不维护旧测试档迁移或补偿；当前跨局成长入口是 F11 Gear Mod。
...
- 历史落地时新增过 `docs/代码/meta_progression_system.md`；ADR #117 后该模块文档随旧运行时删除。后续只查 `docs/代码/gear_mod_system.md` / `docs/代码/save_manager.md` 处理当前 Gear Mod 与 `meta.gear_mods`。
- `docs/代码/README.md`
