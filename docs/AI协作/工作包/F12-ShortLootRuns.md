...
- **当前已落地首片**：默认局已改为偏外侧投放、0-1 / 1-4 / 4-7 / 7-9 / 9+ 分钟导演阶段、四个 director 兴趣点、可领取 dust / Gear Mod 奖励、小巢核完成面板，以及可被子弹摧毁的 Mod 缓存 / 精英巢点 / 小巢核目标；真实宝箱交互、正式核心实体行为 / 美术、撤离和完整结算清单待做。
...
3. 做 3 个首片兴趣点：精英巢点、Mod 缓存、资源缓存。（已做 director 机关占位；资源缓存可进圈领取，精英巢点 / Mod 缓存已有可伤害目标和首版奖励，真实守卫 / 宝箱交互待做）
4. 做小巢核终点：击破后给高价值结算或返回局外。（已做 7 分钟压力窗口、小巢核可伤害目标、保底 dust / Mod 奖励和完成面板；正式核心行为 / 撤离 / 完整结算待做）
