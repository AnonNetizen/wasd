...
| Skill | 路径 | 用途 |
|-------|------|------|
| `godot-gdscript` | `.agents/skills/godot-gdscript/SKILL.md` / `.codebuddy/skills/godot-gdscript/SKILL.md` / `.codex/skills/godot-gdscript/SKILL.md` / `.opencode/skills/godot-gdscript/SKILL.md` / `.claude/skills/godot-gdscript/SKILL.md` | 五份同步的 Godot 4.7.1 + typed GDScript 实现指引；强化数据驱动、autoload、InputService / GUIDE 和正式 client 边界 |
