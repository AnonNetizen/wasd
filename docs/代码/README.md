...
| GearModSystem | `docs/代码/gear_mod_system.md` | `client/scripts/autoload/gear_mod_system.gd`、`client/data/gear_mods.json`、`client/data/gear_mod_drop_tables.csv`、`client/data/gear_mod_fusion_costs.csv`、`client/tools/gear_mod_smoke.gd` | F11 数据 / 契约与运行时首片已建立，UI / 补偿迁移待实现 |
