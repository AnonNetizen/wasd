...
| Replay | `docs/代码/replay.md` | `client/scripts/autoload/replay.gd` | Replay v3：组合、四技能与冲刺 intent |
| PoolManager | `docs/代码/pool_manager.md` | `client/scripts/autoload/pool_manager.gd` | F2 第五片已建立 |
| SaveManager | `docs/代码/save_manager.md` | `client/scripts/autoload/save_manager.gd` | Meta v2 / Run v9、世界事件事务、显式攻击 / 击退 / 威胁时间与旧 Run 明确拒绝 |
...
| Gameplay Runtime | `docs/代码/gameplay_runtime.md` | `client/scripts/gameplay/*.gd`、`client/scripts/ui/title_menu.gd`、`client/scripts/ui/pause_menu.gd`、`client/scripts/ui/game_over_panel.gd`、`client/scripts/boot/formal_client_boot.gd` | Run v9 对局编排、模块世界与世界事件已建立 |
| DifficultyProgression | `docs/代码/difficulty_progression.md` | `client/scripts/data/difficulty_progression.gd`、`client/data/difficulty_profiles.json`、`client/scripts/gameplay/gameplay_run_loop.gd` | ADR #166 模式级威胁时间、出生倍率与起点门禁 |
...
| ModuleWorldManager | `docs/代码/module_world_manager.md` | `client/scripts/gameplay/module_world_manager.gd`、`client/scripts/gameplay/module_chunk.gd`、`client/data/module_worlds.json`、`client/data/module_templates.json`、`client/data/modules/*.json` | schema v3 限量事件模板、12 chunk 与 Run v9 固定模块快照 |
...
| WorldEventSystem | `docs/代码/world_event_system.md` | `client/scripts/gameplay/world_events/`、`client/scenes/gameplay/world_events/`、`client/data/world_events.json` | ADR #173 五类交互事件、后台固定、奖励与 Run v9 幂等恢复 |
