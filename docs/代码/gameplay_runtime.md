...
| `GameplayRunLoop.create_run_snapshot()` | 无 | `Dictionary` | 生成 Run v19 payload；保存 mod environment、GameplayEffectRuntime、Gear Mod 棋盘 / 地面实例及其余确定性对局状态，不保存核心或 pending placement transaction |
