...
Run v10 保存生命、普通护盾、超量护盾、护盾门、元素被动、玩家敌人击退、Enemy 显式攻击 / armed / 生成序号、锁定金币及世界事件目标上下文；旧 Run v9 因缺少敌人奖励快照和 `RNG.economy` 状态明确不迁移。Replay v3 wire format 不变，数据指纹与黄金摘要随当前行为重录。
