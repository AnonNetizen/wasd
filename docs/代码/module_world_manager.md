...
| API | 用途 |
|-----|------|
| `configure(world_def, registry_by_id, templates_by_id, run_seed, navigation_flow_radius_cells)` | 设置世界、局部活动流场半径并生成默认 assignment；半径由 `GameplayRunLoop` 从 EnemyAI 最大视觉范围推导 |
