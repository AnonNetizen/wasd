...
## 1. 项目是什么
固定斜俯视 2.5D 刷宝动作生存游戏（灵感：《星际战甲》与《暗黑》的刷装备 / 刷词条长期追求 + 《哈迪斯》的斜俯视舞台可读性 + 《吸血鬼幸存者》的开放有限大地图与生存压力 + 《以撒的结合》的道具 / 机关 / 构筑组合）。项目保留局内随机奖励和单局构筑变化，但不再沿用旧类型定位；玩法判定仍在 2D 平面内，当前 `Camera2D` 保持水平居中和等比缩放，斜俯视观感由舞台地面、障碍物、遮挡层级与 2.5D 角色视觉承担。
