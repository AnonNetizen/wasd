...
| **启动 / 推进正式项目** | 优先读当前阶段工作包；F5 暂停 / 存档 / 续局已通过最终手动 checklist，当前 F6 入口为 `docs/AI协作/工作包/F6-MetaProgression.md`，优先准备局外成长奖励、结算和 meta 存档闭环；F4 历史入口为 `docs/AI协作/工作包/F4-MinPlayableLoop.md`，F3 数据闭环入口为 `docs/AI协作/工作包/F3-DataLoader.md` |
