...
| **用项目级 AI skill** | OpenCode 加载 `.opencode/skills/<name>/SKILL.md`；当前覆盖 Godot 实现、场景验证、Godot 测试诊断、文档同步、安全提交、事实 review、AI 资源筛选和 MCP 评估；资源筛选与安装清单见 `docs/AI协作/AI技能资源评估.md` |
