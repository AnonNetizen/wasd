...
SECTIONS: tuple[ContractSection, ...] = (
    ...
    ContractSection(
        ...
        "gear_mod_component_types.gd",
        "GearModComponentTypes",
    ),
    ContractSection(
        "gear_mod_board_rules",
        "## 13-E. Gear Mod 棋盘规则 gear_mod_board_rule",
        "gear_mod_board_rules.gd",
        "GearModBoardRules",
    ),
    ContractSection("gear_mod_placement_outcomes", "## 13-F. Gear Mod 放置结果 gear_mod_placement_outcome", "gear_mod_placement_outcomes.gd", "GearModPlacementOutcomes"),
