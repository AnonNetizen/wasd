...
const TRANSLATIONS: Dictionary = {
	LOCALE_ZH_CN: {
		...
		"hud_ultimate_release": "松开 E，再按住合体",
		"hud_ultimate_returning": "AI 正在归队…",
		"hud_ultimate_syncing": "合体同步 {elapsed} / {duration} 秒",
	...
	LOCALE_EN: {
		...
		"hud_ultimate_release": "Release E, then hold again",
		"hud_ultimate_returning": "AI Returning...",
		"hud_ultimate_syncing": "Merge Sync {elapsed} / {duration}s",
