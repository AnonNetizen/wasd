...
const TRANSLATIONS: Dictionary = {
	LOCALE_ZH_CN: {
		...
		"main_settings": "设置",
		"main_hint": "WASD / 方向键移动    鼠标射击    Q 主动道具    T 表情轮",
	...
	LOCALE_EN: {
		...
		"main_hint": "WASD / Arrow Keys Move    Mouse Fire    Q Active Item    T Emote Wheel",
		"ready_room_kicker": "READY ROOM",
		...
		"settings_fullscreen": "Borderless Fullscreen",
		"settings_back": "Back",
		"language_zh_cn": "简体中文",
		"language_en": "English",
