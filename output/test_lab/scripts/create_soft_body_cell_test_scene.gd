...
const OUTPUT_SCENE_PATH := "res://scenes/soft_body_cell_test.tscn"
const SCENE_SCRIPT := preload("res://scripts/soft_body_cell_test.gd")


func _initialize() -> void:
	var scene_root := Node2D.new()
	scene_root.name = "SoftBodyCellTest"
