...
const SCENE_PATH := "res://scenes/orthographic_3d_test.tscn"
const SCREENSHOT_PATH := "E:/GameProjects/wasd/wasd/output/test_lab/screenshots/orthographic_3d_test.png"
