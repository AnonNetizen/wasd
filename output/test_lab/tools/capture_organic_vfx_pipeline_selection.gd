...
const CAPTURES: Array[Dictionary] = [
	{"name": "overview", "time": 0.43},
	{"name": "charge", "time": 0.34},
	{"name": "contact", "time": 0.56},
	{"name": "aftermath", "time": 0.92},
]
...
func _capture_all() -> void:
	...
	for definition: Dictionary in CAPTURES:
		...
		if image.get_size() != Vector2i(1280, 760):
			...
			quit(1)
			return
		var path: String = "res://screenshots/organic_vfx_pipeline_selection_%s.png" % definition["name"]
