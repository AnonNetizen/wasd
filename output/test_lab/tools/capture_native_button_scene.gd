...
const SCENE_PATH := "res://scenes/native_button_scene.tscn"
const SCREENSHOT_PATH := "E:/GameProjects/wasd/wasd/output/test_lab/screenshots/native_button_scene.png"
