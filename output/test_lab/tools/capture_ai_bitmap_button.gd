...
const SCENE_PATH := "res://scenes/ai_bitmap_button_test.tscn"
const SCREENSHOT_PATH := "E:/GameProjects/wasd/wasd/output/test_lab/screenshots/ai_bitmap_button_test.png"
