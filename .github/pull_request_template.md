...
## 关联 Issue / 决策
<!-- 关联 issue 编号；若涉及既定决策，引用 决策记录.md 中的条目 -->
...
- [ ] 约定字符串都来自 `词表与契约.md` 且以**常量/枚举**引用（无裸字符串）
...
- [ ] 已更新 `AI导航.md` 相关入口
- [ ] 已更新 `决策记录.md`（若涉及决策变更）
- [ ] 已更新 `游戏设计文档.md` / `词表与契约.md`（若涉及设计/契约变更）
- [ ] 已更新 `.codebuddy/rules/game-coding-rules.md`（若涉及新规则）
