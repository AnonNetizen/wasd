---
description: 固定斜俯视 2.5D 刷宝动作生存游戏项目编码规则，所有代码的编写/修改/生成都必须遵循
alwaysApply: true
---
...
- 固定斜俯视 / 哈迪斯式显示不得通过旋转 `Camera2D` 或 `Camera2D.zoom` 非等比缩放来模拟透视；相机保持屏幕水平与等比缩放，斜俯视观感由地面美术、障碍物、角色 / 敌人视觉层、Y-sort / 遮挡和房间 / 舞台构图承担，避免横向与纵向屏幕移动速度失真。
