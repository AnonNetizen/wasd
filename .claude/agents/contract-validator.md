...
3. `.claude/rules/game-coding-rules.md` 第 15 节
...
- [ ] 数据 CSV / JSON（如 `gear_mods.json` / `meta_progression.json` / `enemies.csv` 等）中的 stat / trigger / condition / action / meta id 是否全在白名单？
