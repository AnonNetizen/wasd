...
>
> **AI 修改说明**：修改本文档前先读 `docs/AI协作/文档维护指南.md`。README 是仓库入口摘要；改项目状态、运行方式、目录结构或 AI 开工入口时，必须同步 `CONTRIBUTING.md`、`AGENTS.md`、`docs/AI导航.md`、`docs/AI记忆/项目记忆.md`。
...
| [`docs/修改建议.md`](docs/修改建议.md) | 待决策的开放问题（A~D） | 评估扩展方向时 |
