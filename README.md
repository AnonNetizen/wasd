...
> 一款偏《星际战甲》与《暗黑》内核的俯视角刷宝动作生存游戏，保留局内随机奖励、构筑选择和生存压力，但不再沿用旧类型定位。
...
## 一句话定位
WASD / 手柄左摇杆移动，方向键 / 手柄右摇杆或 D-pad 控制射击方向，**全自动开火**；在开放有限大地图中反复刷装备、词条、遗物、技能资源和局外成长，用掉落追求与构筑迭代驱动长期复刷，在敌群与机关中推进破巢行动。
