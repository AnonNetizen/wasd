...
> 一款偏《星际战甲》与《暗黑》内核、视角表现参考《哈迪斯》的固定斜俯视 2.5D 刷宝动作生存游戏，玩法仍按 2D 平面移动 / 碰撞 / 刷怪；`Camera2D` 保持屏幕水平和等比缩放，斜俯视观感由舞台地面、障碍物、遮挡层级和低模角色承担，避免横纵屏幕移动速度失真；保留局内随机奖励、构筑选择和生存压力，但不再沿用旧类型定位。
